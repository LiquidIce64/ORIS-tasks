...
class Ui_RoomBrowser(object):
    def setupUi(self, RoomBrowser):
        ...
        self.horizontalLayout = QtWidgets.QHBoxLayout(RoomBrowser)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.table_rooms = QtWidgets.QTableWidget(parent=RoomBrowser)
        self.table_rooms.setObjectName("table_rooms")
        self.table_rooms.setColumnCount(0)
        self.table_rooms.setRowCount(0)
        self.horizontalLayout.addWidget(self.table_rooms)
        ...
        self.layout_sidepanel.addItem(spacerItem)
        ...
        self.horizontalLayout.addLayout(self.layout_sidepanel)
