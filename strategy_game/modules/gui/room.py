# Form implementation generated from reading ui file 'C:\Users\gilya\Projects\PyCharm\ORIS-tasks\strategy_game\modules\gui\room.ui'
#
...
"}")
        ...
        self.frame_game.setMinimumSize(QtCore.QSize(412, 256))
        self.frame_game.setObjectName("frame_game")
        self.layout_game = QtWidgets.QVBoxLayout(self.frame_game)
        self.layout_game.setContentsMargins(0, 0, 0, 0)
        ...
        self.timer_progress.setMaximum(12000)
